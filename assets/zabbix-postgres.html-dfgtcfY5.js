...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,13),l=[t];function r(d,o){return a(),e("div",null,l)}const p=s(i,[["render",r],["__file","zabbix-postgres.html.vue"]]),m=JSON.parse('{"path":"/postgres/zabbix-postgres.html","title":"Postgres no Zabbix","lang":"en-US","frontmatter":{},"headers":[],"git":{"updatedTime":1748359938000,"contributors":[{"name":"Celso Nery","email":"celso.nery@gmail.com","commits":1}]},"filePathRelative":"postgres/zabbix-postgres.md"}');export{p as comp,m as data};
