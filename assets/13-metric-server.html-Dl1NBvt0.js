import{_ as s,c as e,o as n,e as a}from"./app-D3TVpeeg.js";const l={},i=a(`<h1 id="metric-server" tabindex="-1"><a class="header-anchor" href="#metric-server"><span>Metric server</span></a></h1><p>kubectl apply -f https://github.com/kubernetes-sigs/metrics-server/releases/latest/download/components.yaml</p><p>Rodando:</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">kubectl get pods --all-namespaces</span>
