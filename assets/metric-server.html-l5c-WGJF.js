import{_ as s,c as e,o as n,a}from"./app-h7mth2r0.js";const l={},i=a(`<h1 id="metric-server" tabindex="-1"><a class="header-anchor" href="#metric-server"><span>Metric server</span></a></h1><p>kubectl apply -f https://github.com/kubernetes-sigs/metrics-server/releases/latest/download/components.yaml</p><p>Rodando:</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">kubectl get pods --all-namespaces</span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,13),r=[i];function t(p,c){return n(),e("div",null,r)}const o=s(l,[["render",t],["__file","metric-server.html.vue"]]),m=JSON.parse('{"path":"/kubernetes/metric-server.html","title":"Metric server","lang":"en-US","frontmatter":{},"headers":[],"git":{"updatedTime":1748359938000,"contributors":[{"name":"Celso Nery","email":"celso.nery@gmail.com","commits":1}]},"filePathRelative":"kubernetes/metric-server.md"}');export{o as comp,m as data};
