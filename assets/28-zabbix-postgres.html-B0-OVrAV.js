...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,13),l=[t];function r(d,o){return a(),s("div",null,l)}const p=e(i,[["render",r],["__file","28-zabbix-postgres.html.vue"]]),m=JSON.parse('{"path":"/br/kubernetes/28-zabbix-postgres.html","title":"Postgres no Zabbix","lang":"Português","frontmatter":{},"headers":[],"git":{"updatedTime":1748002949000,"contributors":[{"name":"Celso Nery","email":"celso.nery@gmail.com","commits":1}]},"filePathRelative":"br/kubernetes/28-zabbix-postgres.md"}');export{p as comp,m as data};
