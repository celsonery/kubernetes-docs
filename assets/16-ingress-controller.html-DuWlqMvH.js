import{_ as s,c as n,o as a,e}from"./app-D7xdoRJX.js";const p={},l=e(`<h1 id="ingress-controller" tabindex="-1"><a class="header-anchor" href="#ingress-controller"><span>Ingress Controller</span></a></h1><ul><li><p>Site https://kubernetes.github.io/ingress-nginx/</p></li><li><p>Instalação via helm helm upgrade --install ingress-nginx ingress-nginx --repo https://kubernetes.github.io/ingress-nginx --namespace ingress-nginx --create-namespace</p></li><li><p>Criar ingress.yaml</p></li></ul><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml" data-title="yml"><pre><code><span class="line"><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> networking.k8s.io/v1</span>
